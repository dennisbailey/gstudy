...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('cards').insert({deck_id: 1, question: 'Boolean', answer: 'In computer science, a boolean is a logical data type that can have only the values true or false.'}),
    knex('cards').insert({deck_id: 1, question: 'Null', answer: 'In computer science, a null value represents a reference that points, generally intentionally, to a nonexistent or invalid object or address. The meaning of a null reference varies among language implementations.'}),
    knex('cards').insert({deck_id: 1, question: 'Undefined', answer: 'A primitive value automatically assigned to variables that have just been declared or to formal arguments for which there are no actual arguments.'}),
    knex('cards').insert({deck_id: 1, question: 'Number', answer: 'In JavaScript, Number is a numeric data type in the double-precision 64-bit floating point format (IEEE 754). In other programming languages different numeric types can exist, for examples: Integers, Floats, Doubles, or Bignums.'}),
    knex('cards').insert({deck_id: 1, question: 'String', answer: 'In any computer programming language, a string is a sequence of characters used to represent text. \n In JavaScript, a String is one of the primitive values and the String object is a wrapper around a String primitive.'}),
    knex('cards').insert({deck_id: 1, question: 'Object', answer: 'Object refers to a data structure containing data and instructions for working with the data. Objects sometimes refer to real-world things, for example a car or map object in a racing game. JavaScript, Java, C++, Python, and Ruby are examples of object-oriented programming languages.'}),
